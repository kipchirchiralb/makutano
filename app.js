...
// create a diffrerent registration form, routes(/register) and table with more user information - firstname,lastname,email,phone,password, yob, gender, country, city
